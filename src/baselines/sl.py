# ===========================================================
# Split Learning: ResNet18 on CIFAR-10
...
from utils import (seed_everything, get_device, prRed, prGreen, load_cifar10,
                   ...
                   save_results_csv, save_client_checkpoint)
...
# ============================================================================
#  Training loop — SL: sequential clients, no FedAvg
# ============================================================================
for iter in range(args.epochs):
    ...
    for idx in idxs_users:
        ...
        # In SL: each client's trained model passes to the next client
...
if args.save_client_ckpt:
    ckpt_path = save_client_checkpoint(net_glob_client, "sl", args.cut_layer,
